...
public class EditMaskParser {
	...
	/**
	 * @param editMask
	 *            The complete edit mask
	 * @throws EditMaskParseException
	 */
	public EditMaskParser(String editMask) throws EditMaskParseException {
		LinkedList<EditMaskLexerAndToken> tokens = new LinkedList<EditMaskLexerAndToken>();
		int position = 0;
	...
	/**
	 * @param input
	 *            the user input which may or may not be in valid format
	 */
	...
	/**
	 * @param startingAt
	 *            The current index within the user input string
