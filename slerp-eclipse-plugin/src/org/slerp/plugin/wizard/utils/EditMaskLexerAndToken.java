...
public class EditMaskLexerAndToken {
	 ...
	 */
	private static ArrayList<String> inputRegexes = new ArrayList<String>();
	{
	...
	private String charRegex = null; // A regex for matching input characters or
										// null
	 ...
	 * 
	 * @param inputMask
	 *            The entire edit mask
	 * @param position
	 *            The position to begin parsing
	 * @return The number of characters consumed
	 * @throws EditMaskParseException
	 *             If it encountered a syntax error during the parse
	 */
	 ...
	 *         implementation, this is exactly one character. Once quantifiers
	 *         are implemented, this could be many characters. If no characters
	 *         have been accepted, returns null.
	 */
	...
	/**
	 * @return A position may be complete and yet able to accept more characters
	 *         if the position includes optional characters via a quantifier of
	 *         some type. Not implemented right now.
	 */
	...
	/**
	 * @return the minimum number of characters this RegexLexer must accept in
	 *         order to be complete. Because we don't yet support quantifiers,
